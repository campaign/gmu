...
var Zepto = (function() {
  ...
  zepto.matches = function(element, selector) {
    ...
    var matchesSelector = element.webkitMatchesSelector || element.mozMatchesSelector ||
                          element.oMatchesSelector || element.matchesSelector || element.msMatchesSelector
  ...
  // `$.zepto.fragment` takes a js string and an optional tag name
  // to generate DOM nodes nodes from the given js string.
  ...
  // Explorer. This method can be overriden in plugins.
    /**
     *  modified by chenluyang
     *  @reason 为ie10的dom对象添加__proto__属性
     *  @original
  ...
  zepto.init = function(selector, context) {
    ...
    // If a Zepto collection is given, juts return it
      ...
      // If it's a js fragment, create nodes from it
  ...
  // objects to the `target` object.
    ...
    $.extend = function(target){
        ...
        //新增的功能，当首个参数为true时，进行深度复制，复制到第二个参数
  ...
  $.fn = {
    ...
    show: function(){
      return this.each(function(){
          /**
           * modified by chenluyang
           * @reason ie10 设置style.display = null，getComputeStyle获取的值不准确
           * @original this.style.display = null
           */
    ...
    /**
     * modified by chenluyang
     * @reason 若浏览器不支持getBoundingClientRect方法
     * @original
     * offset: function(){
    ...
    offset: function(coordinates) {
      ...
      return function(ignore) {
        ...
        var obj = getBCR(this[0]),
            ...
            pageY = ignore ? 0 : window.pageYOffset;
        return {
          left: obj.left + pageX,
          top: obj.top + pageY,
          width: obj.width,
          height: obj.height,
          right: obj.right + pageX,
          bottom: obj.bottom + pageY
        }
      }
    }(),
...
;(function($){
    ...
    function fix(event) {
        /**
         * modified by chenluyang
         * @reason ie10下event的defaultPrevented属性无法被修改
         * @original
    ...
    $.fn.on = function(event, selector, callback){
        /**
         * modified by chenluyang
         * @reason 处理on(event, null || undefined, callback)情况
         * @original this.bind(event, selector)
         */
    ...
    $.fn.trigger = function(event, data){
        /**
         *  modified by chenluyang
         *  @reason android 2.2/2.3  不支持event.stopImmediatePropagation方法，
         *          直接调用原生函数dispatchEvent就忽略了stopImmediatePropagation方法。
         *          现手动模拟事件冒泡，若发现调用event.stopPropagation 或 event.stopPropagation，则停止事件冒泡
         *  @original
        ...
        return this.each(function(i, element){
            ...
            e.data = data
            e.target = element
            $.each($(this).add($(this).parents()).add(document), function(i, element){        //遍历冒泡元素
                //console.log(element)
    ...
    // doesn't trigger an actual event, doesn't bubblex
