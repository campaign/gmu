	...
	$.widget('suggestion', {
		...
		_create: function() {
			var me = this,
				...
				sugID = me.data('sugId', "ui-suggestion-" + $.GMU.guid()),
			...
			me.root($('<div id="' + sugID + '" class="ui-suggestion"><div class="ui-suggestion-content"><div class="ui-suggestion-scroller"></div></div><div class="ui-suggestion-button"></div></div>').appendTo(appendTo ? $(appendTo) : $maskElem));
		...
		_setSize: function() {
			...
			me.root().css('width', width + additionWidth);
			return me;
		},
		...
		_bindSuggestionListEvent: function() {
			...
			me.root().find(".ui-suggestion-scroller li").each(function(index, item) {
		...
		hide: function() {
			var me = this;
			$.later(function(){
                me.root().css("display", "none").trigger('hide');
            }, 20);
