...
test("只为加载css用",function(){
    expect(1);
    stop();
    ua.loadcss(["reset.css",  "loading.default.css", "webapp/refresh/refresh.default.css", "webapp/refresh/refresh.iOS5.default.css"], function(){
        ok(true, '样式加载进来了！');
        start();
    });
});
