...
//            print '<script type="text/javascript" src="../../../third-party/iscroll/iscroll.js"></script>'."\n";
        ...
        public function print_js( $caseName , $cov ,$release=false)
        {
            ...
            if($release){  //为了支持release模式而修改 田丽丽
                ...
                $importurl = "import.php?f=core/zepto.extend,core/zepto.core,core/zepto.support,core/zepto.event,core/zepto.fix,core/zepto.fx,core/zepto.highlight,core/zepto.iscroll,core/zepto.ui,webapp/button,webapp/dialog,webapp/navigator,webapp/toolbar,chart/core/chart,chart/line/lineChart,$caseName\n";
                if ( $cov )
                    $importurl .= '&cov=true';
