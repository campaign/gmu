    ...
    (function($){
        ...
        $.fn.iScroll = function(method){
            ...
            if(typeof method == 'string'){
                var instance = cacheInstance[this.data('_iscroll_')],pro;
                ...
                createInstance(this,method)
            }
            return this;
        }
    })(typeof window.Zepto == 'undefined' ? null : window.Zepto)
 ...
 *
 * Scroll needs to be initialized for each scrolling area you need. There’s no limit to the number of iScrolls you can have on any single page, if not that imposed by the device memory/cpu. The type and length of the contents influence the number of iScrolls you can use simultaneously.
 *
